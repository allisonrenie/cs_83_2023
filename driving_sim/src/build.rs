...
/// Builds car model, utilizing other functions to build the chassis, steering, suspension, 
/// and wheels. 
pub fn build_model(
...
fn build_wheel(
    ...
    add_engine(&mut wheel_e); /// Adding in the engine here
...
/// Basic function to add an engine to an entity
